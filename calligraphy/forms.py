...
class CalligraphyForm(forms.Form):
    ...
    fuente = forms.ChoiceField(choices=[
        ("manuscrita", "Manuscrita"),
        ("cursiva", "Cursiva"),
        ("mayúsculas", "Mayúsculas"),
        ("mixta", "Mixta"),
    ], initial="manuscrita")
    tamaño_letra = forms.TypedChoiceField(choices=[(12, "12 pt"), (18, "18 pt"), (24, "24 pt"), (36, "36 pt")], coerce=int, initial=24)
    num_paginas = forms.IntegerField(min_value=1, max_value=50, initial=5)
    lineado = forms.ChoiceField(choices=[
        ("pauta", "Pauta"),
